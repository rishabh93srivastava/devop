...
//to create beans
  	...
  	public SessionFactory sessionFactory() {
  		...
  		Class classes[]=new Class[]{Product.class,Category.class,Authorities.class,BillingAddress.class,Cart.class,CartItem.class,Customer.class,ShippingAddress.class,User.class};
